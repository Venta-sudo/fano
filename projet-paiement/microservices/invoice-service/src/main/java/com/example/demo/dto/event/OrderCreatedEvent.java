...
// Ce DTO représente l'événement 'order-created' que nous nous attendons à recevoir du order-service.
// Pour que cela fonctionne correctement, le order-service devra être modifié pour publier des JSON de ce type.
